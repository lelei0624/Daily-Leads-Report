"""
data_processor.py — Transforms raw HubSpot deal records into dashboard metrics.
"""
...
def compute_metrics(df):
    ...
    if weekday == 0:
        report_start = (today_pd - pd.Timedelta(days=3)).normalize()
        report_end   = (today_pd - pd.Timedelta(days=1)).normalize()
